...
export const NoUserIcon = ({ className = 'w-24 h-24' }: { className?: string }) => (
...
export const CogIcon = ({ className = 'w-5 h-5' }: { className?: string }) => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className={className}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M9.594 3.94c.09-.542.56-1.007 1.113-1.113l.448-.112c.542-.136 1.122.067 1.487.512l.379.479c.365.462.946.691 1.487.512l.448-.112c.542-.136 1.023.07 1.113.612l.162.772c.09.542-.067 1.122-.512 1.487l-.479.379c-.462.365-.691.946-.512 1.487l.112.448c.136.542-.07 1.023-.612 1.113l-.772.162c-.542.09-1.122-.067-1.487-.512l-.379-.479a1.803 1.803 0 0 0-1.487-.512l-.448.112c-.542.136-1.023-.07-1.113-.612l-.162-.772a1.803 1.803 0 0 1 .512-1.487l.479-.379c.462-.365.691.946.512-1.487l-.112-.448c-.136-.542.07-1.023.612-1.113l.772-.162c.542-.09 1.122.067 1.487.512l.379.479c.365.462.946.691 1.487.512l.448-.112c.542-.136 1.023.07 1.113.612l.162.772a1.803 1.803 0 0 1-.512 1.487l-.479.379c-.462.365-.691.946-.512 1.487l.112.448c.136.542-.07 1.023-.612 1.113l-.772.162c-.542.09-1.122-.067-1.487-.512l-.379-.479a1.803 1.803 0 0 0-1.487-.512l-.448.112c-.542.136-1.023-.07-1.113-.612l-.162-.772a1.803 1.803 0 0 1 .512-1.487l.479-.379c.462-.365.691.946.512-1.487l-.112-.448c-.136-.542.07-1.023.612-1.113l.772-.162" />
      <path strokeLinecap="round" strokeLinejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" />
    </svg>
  );
